...
offitialPath = '~/Dropbox/TFOCS/';
yixingPath = '/home/linuxthink/Dropbox/courses/ece273/project/packages/tfocs/TFOCS-1.3.1/';
yerlanPath = '~/aPlaceHolder/';
if exist(offitialPath, 'dir')
    addpath(offitialPath)
end
if exist(yixingPath, 'dir')
    addpath(yixingPath)
end
if exist(yixingPath, 'dir')
    addpath(yixingPath)
